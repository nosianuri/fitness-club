...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_iks8czh', 'template_naqpcgl', form.current, 'M-0P2iiK8FWLBxvVk')
      .then((result) => {
    ...
    <section className='section-sm lg:pt-[250px]'>
      <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-row lg:gap-x-[74px] bg-contact bg-no-repeat bg-cover min-h-[600px]'
          data-aos='zoom'
          data-aos-offset='400'>
          <div className='flex-1 flex flex-col justify-center pl-8' data-aos='fade-down'
            data-aos-delay='300'
            data-aos-offset='500'>
          ...
          <form
            ...
            ref={form} className='flex-1 bg-white shadow-primary rounded-[20px] p-5 lg:p-10 flex flex-col gap-y-5 max-h-[600px] lg:-mt-20' data-aos='fade-up'
            data-aos-delay='300'
            data-aos-offset='500'>
