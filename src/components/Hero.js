    ...
    <div className='container mx-auto'>
      ...
      <div className='flex flex-col items-center lg:flex-row lg:items-start pt-32'>
        <div className='flex-1 lg:mt-12'>
          ...
          <p className='mb-6 lg:mb-12 max-w-[480px] lg:text-lg' data-aos='fade-down'
            data-aos-delay='600'
          >Yoga is a way of life, rather than a chore. Counteract the stresses of modern life by becoming more mindful and compassionate.</p>
