...
const Cards = () => {
  return (
    <section className='bg-cardsBg min-h-[260px] pb-[55px] lg:mt-24' data-aos='fade-up'
    data-aos-delay='800'
    ...
    <div className='container mx-auto flex flex-col lg:flex-row gap-x-[32px]'>
      <div className='flex-1 flex gap-x-[15px] lg:gap-x-[32px] -mt-[38px] z-10 lg:-mt-[77px] mx-auto'>
        <div className='bg-white w-full max-w-[282px] p-[14px] lg:p-[26px] shadow-2xl rounded-md max-h-[282px]' data-aos='fade-up'
            data-aos-delay='400'>
