      ...
      <div className='container mx-auto'>
        ...
        <div className='flex flex-col md:flex-row md:items-center md:-space-x-12 -space-y-24 lg:-space-y-0'>
          ...
          <div
            ...
            data-aos-delay='200'
          >
            <h2 className='h1 md:text-[60px] md:leading-[62px] text-orange mb-4 lg:mb-6'>
              Wanna join <span className='text-primary-200'>&</span> have fun?
            </h2>
            <p className='text-body-sm md:text-body-md text-heading mb-4 lg:mb-6 max-w-[348px] md:max-w-[470px] lg:max-w-[492px]'>
              {subtitle}
            </p>
